...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "https://salmaluna13.github.io"}}, methods=["GET", "POST"], allow_headers=["Content-Type"])  # Esto permite todas las solicitudes desde cualquier origen
